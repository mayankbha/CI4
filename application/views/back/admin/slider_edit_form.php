<?php
    foreach($slider_data as $row1){
		...
		//echo '<pre> $elements :: '; print_r($elements);
		...
		//echo '<pre> $style :: '; print_r($style);
		//echo '<pre> $videos :: '; print_r($videos);
?>
								...
								<div id="backup_slider" style="display: none;">
									<div class="ls-slide" <?php echo $style['full_slide_style']; ?>>
										...
										<?php foreach($style['buttons'] as $btn) { ?>
											<<?php echo $btn['element']; ?> type="<?php echo $btn['type']; ?>" class="ls-l out_<?php echo $btn['name']; ?>" onclick="window.open('<?php echo $btn['btn_url']; ?>', '<?php echo $btn['target']; ?>');" style="<?php echo $btn['style']; ?> color:<?php echo $btn['color']; ?>; background:<?php echo $btn['background']; ?>;" data-ls="<?php echo $btn['data_ls']; ?>"><?php echo $btn['text']; ?></<?php echo $btn['element']; ?>>
										<?php } ?>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="col-sm-5 control-label" for="demo-hor-inputemail">
										<input type="radio" name="bg_type" value="bg_img" id="bg_type_radio" <?php if($row1['bg_type'] == 'bg_img') echo 'checked'; ?> />
									...
									<div class="col-sm-6">
									   ...
									   <span class="pull-left btn btn-default btn-file">
											...
											<input type="file" name="background" id="background" class='bckimg imgr add-tooltip' data-toggle="tooltip" data-original-title="Default tooltip" <?php if($row1['bg_type'] == 'bg_color') echo 'disabled'; ?> />
										</span>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-5 control-label" for="demo-hor-inputemail">
										<input type="radio" name="bg_type" value="bg_color" id="bg_type_radio" <?php if($row1['bg_type'] == 'bg_color') echo 'checked'; ?> />
									...
									<div class="col-sm-6">
										<div class="col-sm-12">
											<div class="input-group demo2">
												<input type="text" name="background_color" id="background_color" value="<?php echo $row1['background_color']; ?>" class="form-control" <?php if($row1['bg_type'] == 'bg_img') echo 'disabled'; ?> />
									...
									<div class="panel-group" style="border: 1px solid #E6E6E6;border-radius: 4px; padding-top:20px;">
										...
										?>
											<div class="form-group txt_group" >
												...
												<div class="col-sm-6">
													<input type="text" placeholder="" value="<?php echo $txt; ?>" name="<?php echo $btn['name']; ?>" class="in_<?php echo $btn['name']; ?> form-control txt">
												</div>
											</div>  
											<div class="form-group txt_group" >
												<label class="col-sm-5 control-label" for="demo-hor-inputemail">
												...
												<div class="col-sm-6">
													<input type="text" placeholder="" value="<?php echo $btn_url; ?>" name="<?php echo $btn['name']; ?>_button_link" class="in_<?php echo $btn['name']; ?>_button_link form-control txt">
												</div>
											</div>
											<div class="form-group spec_txt_group" data-typ="<?php echo $text['name']; ?>_color" style="display:block;">
												...
												<div class="col-sm-6">
													<div class="input-group demo3">
														<input type="text" name="<?php echo $btn['name']; ?>_color" value="<?php echo $color; ?>" class="form-control color in_<?php echo $btn['name']; ?>_color " >
														<span class="input-group-addon"><i></i></span>
													</div>
												</div>
											</div>
											<div class="form-group spec_txt_group" data-typ="<?php echo $btn['name']; ?>_background" style="display:block;">
												...
												<div class="col-sm-6">
													<div class="input-group demo4">
														<input type="text" name="<?php echo $btn['name']; ?>_background" value="<?php echo $background; ?>" class="form-control color in_<?php echo $btn['name']; ?>_background" >
														<span class="input-group-addon"><i></i></span>
													</div>
												</div>
											</div>
								...
								<div class="col-md-6">
									...
									?>
											<div class="form-group txt_group" >
												...
												<div class="col-sm-6">
													<input type="text" placeholder="" value="<?php echo $txt; ?>" name="<?php echo $text['name']; ?>" class="in_<?php echo $text['name']; ?> form-control txt">
												</div>
											</div>              
											<div class="form-group spec_txt_group" data-typ="<?php echo $text['name']; ?>_color" style="display:block;">
												<label class="col-sm-5 control-label" for="demo-hor-inputemail">
									...
									<div class="panel-group" style="border: 1px solid #E6E6E6;border-radius: 4px; padding-top:20px;">
										...
										?>
											<div class="form-group txt_group" >
												...
												<div class="col-sm-6">
													<input type="text" placeholder="" value="<?php echo $video_url; ?>" name="<?php echo $video['name']; ?>" class="in_<?php echo $video['name']; ?> form-control txt">
												</div>
											</div>
											<hr>
										<?php } ?>
