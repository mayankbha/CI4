<section class="page-section color get_into">
            ...
            <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12">
                ...
                <?php
                    ...
                    <div class="row box_shape">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <span class="btn btn-theme-sm btn-block btn-theme-dark pull-right login_btn enterer" style="background: #93b2ea!important;color:white;">
    ...
    <div class="container2" id="forget" style="display:none">
        <div class="row margin-top-0">
            <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12">
                <?php
                ...
                ?>
                    <div class="row box_shape">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                            ...
                            <span class="btn btn-primary btn-sm forget_btn enterer" style="background: #93b2ea!important;">
